...
export default function AddClient({ open, handleClose, update }) {
    const classes = useStyles()

    const methods = useForm({
        validationSchema: utils.validations.clients.CreateSchema,
    })
    ...
    const sendData = async data => {
        setIsSaving(true)
        const responseSubmit = await api.clients.create(data)
