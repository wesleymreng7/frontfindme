...
export default function EditClient({ open, handleClose, update, client }) {
  const classes = useStyles()

  const methods = useForm({
    validationSchema: utils.validations.clients.UpdateSchema,
  })
  ...
  const sendData = async data => {
    setIsSaving(true)
    const responseSubmit = await api.clients.update(data, client.id)
